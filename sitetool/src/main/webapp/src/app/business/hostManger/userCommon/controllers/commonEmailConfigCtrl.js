define([
    ...
    "use strict";
    var ctrl = ["$scope", "$rootScope", "$compile", "$location", "$timeout","tiValid", "commonEmailConfigServe",
        function($scope, $rootScope, $compile, $location, $timeout, tiValid, commonEmailConfigServe) {
            $scope.i18n = i18n;
            //把从自定义服务传值，传过来的赋值给……
            ...
            $scope.requestsavaEmail ={
                "postSaveData": function(str){
                    var  promise = commonEmailConfigServe.sendEmailConfig(str);
                ...
                "postTestData": function(str){
                    var  promise = commonEmailConfigServe.testEmailConfig(str);
                    promise.then(function(response){
            ...
            $scope.requestOption ={
                "getData": function(){
                    var  promise = commonEmailConfigServe.getTree();
                    promise.then(function(response){
