define([
    ...
    "use strict";
    var ctrl = ["$scope", "$rootScope", "$compile", "$location", "$timeout","tiValid", "adminSystemConfigServe",
        function($scope, $rootScope, $compile, $location, $timeout, tiValid, adminSystemConfigServe) {
            $scope.i18n = i18n;
            //把从自定义服务传值，传过来的赋值给……
            ...
            $scope.requestOption ={
                "postData": function(str){
                    var  promise = adminSystemConfigServe.setSystemConfig(str);
