define([
    ...
    "use strict";
    var ctrl = ["$scope", "$rootScope", "$compile", "$location", "$timeout","tiValid","adminThresholdConfigServe",
        function($scope, $rootScope, $compile, $location, $timeout, tiValid, adminThresholdConfigServe) {
            $scope.i18n = i18n;
            //把从自定义服务传值，传过来的赋值给……
            ...
            $scope.requestOption ={
                "getData": function(){
                    var  promise = adminThresholdConfigServe.getTree();
                ...
                "postData": function(str){
                    var  promise = adminThresholdConfigServe.sendThresholdData(str);
                     console.log(str);
                    promise.then(function(response){
