define([
    ...
    "use strict";
    var ctrl = ["$scope", "$rootScope", "$compile", "commonThresholdConfigServe", "$location", "$timeout",
        function($scope, $rootScope, $compile, commonThresholdConfigServe, $location, $timeout) {
            $scope.i18n = i18n;
            //把从自定义服务传值，传过来的赋值给……
