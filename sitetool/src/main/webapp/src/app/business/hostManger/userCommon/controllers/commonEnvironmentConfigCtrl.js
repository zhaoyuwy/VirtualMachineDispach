define([
    ...
    "use strict";
    var ctrl = ["$scope", "$rootScope", "$compile","$location", "$timeout", "commonEnvironmentConfigServe",
        function($scope, $rootScope, $compile, $location, $timeout, commonEnvironmentConfigServe) {
            $scope.i18n = i18n;
            ...
            $(".openWindow").on('click', function(event, callback) {
                ...
                var addSiteOptions = {
                    ...
                    width: "430px",
                    "content-type": 'url',
                    content: "src/app/business/hostManger/userCommon/views/include/addEvSite.html",
                    resizable: true,
                        ...
                        handler: function (event) {//点击回调函数
                            ...
                            $scope.operate = {
                                "addPassData": function () {
                                    ...
                                    var promise = commonEnvironmentConfigServe.postEvsite(evStr);
                                    promise.then(
                                        function (response) {
            ...
            $scope.addSiteFtn = function($index){  //$index表示的是 表格的第几条（从0开始），对应着
                ...
                var addSiteOptions = {
                    ...
                    width: "430px",
                    "content-type": 'url',
                    content: "src/app/business/hostManger/userCommon/views/include/addSite.html",
                    resizable: true,
                    beforeClose: function () {
                    },
                    buttons: [{
            ...
            $scope.EditSite = function(evName,siteRegionName,siteRegion,siteLoginUser,siteLoginIp){
                ...
                var addSiteOptions = {
                    ...
                    width: "430px",
                    "content-type": 'url',
                    content: "src/app/business/hostManger/userCommon/views/include/sonEditSite.html",
                    resizable: true,
                    beforeClose: function () {
                    },
                    buttons: [{
                        ...
                        handler: function (event) {//点击回调函数
                            ...
                            $scope.operate = {
                                "addPassData": function () {
                                    ...
                                    var promise = commonEnvironmentConfigServe.sonEditsite(evStr);
                                    promise.then(
                                        function (response) {
                                            //var responseData = JSON.parse(response);
            ...
            $scope.loadOperate = {
                "getListData":function(){
                    var promise = commonEnvironmentConfigServe.getEvSite();
                    promise.then(
                        function(response){
                            //var responseData = JSON.parse(response);
